...
using JetFileBrowser.FileBrowser.FileTree.Zip;
    ...
    public class Win32FileSystem : TreeFileSystem, IEnumerableFileSystem {
        ...
        public async Task<bool> LoadContentWin32(string dirPath, TreeEntry target) {
            ...
            try {
                ...
                await IoC.MessageDialogs.ShowMessageAsync("Directory not found", $"'{dirPath}' no longer exists");
                return false;
            }
            catch (UnauthorizedAccessException e) {
                await IoC.MessageDialogs.ShowMessageExAsync("Unauthorized Access", $"Cannot access the folder '{dirPath}'", e.GetToString());
                return false;
            }
            catch (Exception e) {
                await IoC.MessageDialogs.ShowMessageExAsync("Error", $"An error occurred while getting files at '{dirPath}'", e.GetToString());
                return false;
            }
            ...
            try {
                ...
                await IoC.MessageDialogs.ShowMessageExAsync("Error", $"An error occurred while enumerating next file '{dirPath}'", e.GetToString());
                return true;
            }
        ...
        private class Win32AsyncEnumerator : IAsyncEntryEnumerator {
            ...
            public async Task<bool> MoveNext() {
                ...
                try {
                    ...
                    await IoC.MessageDialogs.ShowMessageExAsync("Error", $"An error occurred while enumerating next file", e.GetToString());
                    return false;
                }
